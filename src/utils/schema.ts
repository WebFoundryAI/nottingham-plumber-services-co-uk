...
const CUSTOMER_REVIEWS = [
  ...
  },
  {
    ...
    reviewRating: 5,
    reviewBody: "Used Nottingham Plumber Services for a CCTV survey after repeated drainage issues. They identified the root cause and provided a clear report with options. Very thorough and reasonably priced."
  },
  {
...
export function getBaseBusinessSchema() {
  return {
    ...
    "description": "Professional plumbing and drainage services across Nottingham and surrounding areas. Fast response, no call-out fee, 24/7 availability.",
    "url": siteUrl,
...
export function getLocationPageSchema(location: Location) {
  ...
  const locationSchema = {
    ...
    "areaServed": {
      ...
      "containedInPlace": {
        "@type": "AdministrativeArea",
        "name": location.countyOrRegion || "Nottinghamshire"
      }
    },
    "geo": {
      "@type": "GeoCoordinates",
...
export function getLocationServicePageSchema(location: Location, service: Service) {
  ...
  const serviceSchema = {
    ...
    "description": `Professional ${service.name.toLowerCase()} services in ${location.name}, ${location.countyOrRegion || 'Nottinghamshire'}. Fast response, no call-out fee, 24/7 availability.`,
...
export function getWebSiteSchema() {
  return {
    ...
    "url": siteUrl,
    "name": BRAND.brandName,
    "description": "Professional plumbing and drainage services across Nottingham and surrounding areas.",
    "publisher": {
      "@id": `${siteUrl}/#organization`
    },
    "inLanguage": "en-GB",
